...
public class ModCapability {
    ...
    public static void register(){
        ...
        //If you want to register to player, please use CapabilityUtils.registerPlayerCapabilityWithNetwork()
