...
import io.zershyan.sccore.common.datagen.init.SCCoreLang;
...
public class SCCLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        switch (locale){
            case enUs -> SCCoreLang.langList.forEach(langEntity -> addTranslation(
                    langEntity.key(), langEntity.lang().enUs()));
            case zhCn -> SCCoreLang.langList.forEach(langEntity -> addTranslation(
