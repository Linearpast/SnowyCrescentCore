...
import io.zershyan.sccore.common.datagen.provider.ModLangProvider;
import io.zershyan.sccore.common.datagen.provider.ModPackMetadataProvider;
...
public class DataGenEvent {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeServer(), new ModPackMetadataProvider(packOutput));
